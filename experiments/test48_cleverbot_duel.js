...
Surf to http://cleverbot.com
Open the JavaScript console (F12 | ctrl-shift-J | cmd-shift-J | etc)
...
var UIWrapper = ( function () {
    ...
    p.listen = function () {
        setTimeout( this._listen, 10 );
    };
    
    p._listen = function () {
        //console.log( '*' );
        this.out = this.document.querySelector( this.outSelector );
        this.out.addEventListener( 'DOMNodeRemovedFromDocument', this.listen );
        this.out.addEventListener( 'DOMNodeInserted', this.read );
    };
    ...
    p.read = function () {
        ...
        this.timerId = setTimeout( this._read, 4e2 );
    };
...
var Main = ( function () {
    ...
    function Main () {
        ...
        this.initExtWindow();
        this.ext.addEventListener( 'DOMContentLoaded', this.initExtUIWrapper );
